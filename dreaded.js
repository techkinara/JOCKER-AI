...
const botname = process.env.BOTNAME || 'JOKER AI';
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'𝐉𝐨𝐤𝐞𝐫-𝐀𝐈';
    const packname = process.env.STICKER_PACKNAME || '𝐉𝐨𝐤𝐞𝐫';
const dev = process.env.DEV || '254113634286'
...
┃☙┃
┃☙┗━━━━━━━━━━━━━━᪥
┃    𝑺𝒄𝒓𝒊𝒑𝒕𝒆𝒅 𝒃𝒚 𝐊𝐈𝐍𝐀𝐑𝐀 𝐌𝐀𝐑𝐊
┗━━━━━━━━━━━━━━━━━᪥`;

if (menu === 'VIDEO') {

                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./Mark.mp4'),
                        caption: cap,
...
client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/72615a4dd05a7f00b8228.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
...
break;
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 𝐉𝐨𝐤𝐞𝐫 ☬*`}, { quoted: m }) 
...
case "movie": 
 ...
 client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/kpihws.jpg' }, caption: `𝐇𝐞𝐫𝐞 𝐢𝐬 𝐦𝐲 𝐚𝐧𝐨𝐧𝐲𝐦𝐨𝐮𝐬 𝐜𝐫𝐞𝐚𝐭𝐨𝐫, +254113634286🦈𝒄𝒐𝒏𝒕𝒂𝒄𝒕 𝒉𝒊𝒎 𝒇𝒐𝒓 𝒂𝒏𝒚 𝒊𝒏𝒒𝒖𝒊𝒓𝒊𝒆𝒔😌 ☤☬` }, {quoted: m}); 
...
case 'shinetext':{
reply(client.wait)
if (!q) return reply(`Example : ${prefix+command} Joker`) 
let link
